...
stableversion=$(curl -s https://openwrt.org | sed -n 's/.*Current stable series: OpenWrt \([0-9.]\+\).*/\1/p')
URL="https://downloads.openwrt.org/releases/24.10.0/targets/x86/64/openwrt-24.10.0-x86-64-generic-ext4-combined.img.gz"
